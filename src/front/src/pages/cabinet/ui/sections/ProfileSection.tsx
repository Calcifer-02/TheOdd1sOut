 ...
 *
 * Показывается то, что отдаёт договор, и ничего сверх: телефона и почты схема
 * `Profile` не хранит, и пустые поля для них означали бы «не заполнено» там,
 * где сервис их вовсе не знает (R-051).
 *
