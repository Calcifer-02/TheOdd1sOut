  ...
  return (
    <section className="imolt-card imolt-cabinet-signin" aria-labelledby="imolt-cabinet-signin">
      ...
      <p className="imolt-lead">
        Расчёт и коммерческое предложение работают без входа. Кабинет показывает сохранённые расчёты, подписку и заказ
        документации, поэтому ему нужно знать, кто пришёл. Личность даёт платформа MAX – отдельного пароля у сервиса
        нет.
      </p>
      ...
      {fromChat ? (
        ...
        <>
          ...
          <p className="imolt-lead">Напишите чат-боту ИМОЛТ и откройте мини-приложение кнопкой из переписки.</p>
