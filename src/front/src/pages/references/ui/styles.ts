...
/* Статус, дата актуальности и кнопка — одна запись о полигоне, и в своём
   столбце она стоит по центру: прижатая влево, она читалась хвостом
   соседнего столбца с числами (замечание заказчика от 24.09.2026). */
