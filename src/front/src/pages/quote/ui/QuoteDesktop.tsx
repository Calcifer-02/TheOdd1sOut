 ...
 *
 * Под листом — перечень ранее выпущенных предложений: экран показывает не
 * только текущий документ, но и то, что по этому участнику уже выпущено
 * (решение заказчика от 24.09.2026, AC-036h).
 *
...
import { QuoteHistoryTable } from './QuoteHistory';
...
export function QuoteDesktop({
  ...
  return (
    <div className="imolt-quote-screen">
      ...
      <QuoteHistoryTable history={history} />
    </div>
  );
}
