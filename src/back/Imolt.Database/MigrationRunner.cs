...
///
/// Зонтичное R-007 уровня L1 снято: схему применяет общий компонент, а не
/// реализация свойства продукта. Раскрывающее требование об актуальности
/// данных названо прямо.
///
/// @supports: R-048
/// @adr: ADR-0002
