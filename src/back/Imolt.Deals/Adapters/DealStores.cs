...
///
/// Длительность заказчиком не названа (Q-010) и объявляется настройкой
/// службы: одно место на ответ операции и на документ. Два места, считающие
/// срок по-своему, расходятся молча — в ответе одна дата, у клиента на руках
/// другая.
///
/// @req: R-038
/// @adr: ADR-0005
...
{
  /// Значение по умолчанию, когда настройка не задана. Помечено как
  /// демонстрационное: заказчик срока не называл, и выдавать семь дней за
  /// его решение нельзя.
  public const int DemonstrationDays = 7;
