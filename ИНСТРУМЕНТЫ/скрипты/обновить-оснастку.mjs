...
// переписать ссылку — хуже, чем не переименовать вовсе: замок исчезает из-под
// установщика, и конвейер падает с «Замок версий не найден» уже после слияния.
...
// только полного пути его не находит. Именно так замок и исчез из-под
