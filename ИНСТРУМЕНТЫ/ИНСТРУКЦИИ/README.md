...
> Пользовательские инструкции к средствам из [ходунков](../training-wheels.json).
...
исходников. Копия обновляется при смене версии средства в ходунках — тем же
...
| trip-lint | 0.6.0 | [README](./trip-lint/README.md), [руководство пользователя](./trip-lint/РУКОВОДСТВО_ПОЛЬЗОВАТЕЛЯ.md), [надстройка стека](./trip-lint/НАДСТРОЙКА_СТЕКА.md), [правила SQL](./trip-lint/ПРАВИЛА_SQL.md) | выпуск (README); руководство, надстройка и правила — исходники |
...
Средства `mcp-project-files` и `mcp-team-tester` в ходунках без закреплённой
версии — инструкции появятся вместе с первым закреплённым выпуском.

## Связанные артефакты

- [Средства слоя B в проекте](../README.md)
- [Ходунки](../training-wheels.json)
