...
|---|---|---|---|
| trip-cli | 0.7.0 | [README](./trip-cli/README.md), [CHANGELOG](./trip-cli/CHANGELOG.md), [руководство пользователя](./trip-cli/РУКОВОДСТВО_ПОЛЬЗОВАТЕЛЯ.md), [модель политик](./trip-cli/МОДЕЛЬ_ПОЛИТИК.md) | выпуск; руководство и модель политик — из исходников, версия 0.7.0 |
