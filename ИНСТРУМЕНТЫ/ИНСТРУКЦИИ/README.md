...
> Пользовательские инструкции к средствам из [замка версий](../ЗАМОК_ИНСТРУМЕНТОВ.json).
...
исходников. Копия обновляется при смене версии средства в замке — тем же
коммитом. Расхождение копии с поведением средства — повод обновить копию,
а не править её отдельно от выпуска.

## Состав

| Средство | Версия (замок) | Что лежит | Источник |
|---|---|---|---|
...
Средства `mcp-project-files` и `mcp-team-tester` в замке без закреплённой
версии — инструкции появятся вместе с первым закреплённым выпуском.

## Связанные артефакты

- [Средства слоя B в проекте](../README.md)
- [Замок версий](../ЗАМОК_ИНСТРУМЕНТОВ.json)
